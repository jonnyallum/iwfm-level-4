# IWFM Level 4 FM Academy Master Index
...
ai_metadata:
  ...
  audience:
    ...
    - FM Control Hub training
    - Compliance Hub learning pathways
  rag_tags:
    - index:master
    - course:iwfm-level-4-style
...
This is the navigation layer for the IWFM Level 4 Equivalent FM Academy. Use it to move between modules, interview practice, operational scenarios and product-readiness content.
...
- [Course orientation](00-course-orientation/course-orientation.md)
- [Module 1: FM Principles](01-fm-principles/module-01-fm-principles.md)
- [Module 2: Risk Management](02-risk-management/module-02-risk-management.md)
- [Module 3: Health & Safety Management](03-health-safety/module-03-health-safety-management.md)
- [Module 4: Fire Safety](04-fire-safety/module-04-fire-safety.md)
- [Module 5: Water Hygiene](05-water-hygiene/module-05-water-hygiene.md)
...
Use the `compliance-bible` repo for legal and operational source material:

- Compliance Bible Master Index.
